...
這週同樣看了一些 reduced form 的文章。我通常能夠找到一些問題。可是，這些問題通常
...
Friedberg 認為離婚制度的變化可能有很不同的短期和長期效果。改革後，可能因為積壓的需求，離婚率可能會快速上升，經過複雜的動態變化，然後才逐漸趨於穩定。^[Wolfers 這整段都是以文字描述，詳細我還得再想想。] 為了捕捉動態效果，Wolfers 估計以下的迴歸模型：
$$
\begin{aligned}
